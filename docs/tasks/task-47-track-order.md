# Task 47 — Track Order Screen

> **Phase**: 12 — Static/Info Pages
> **Say**: "generate task 47" or "generate task 47"

## Objective

Create the order tracking screen where users enter their order number.

## Reference

`/ecommerce/app/(with_footer)/track-order/page.tsx`

## File to Create

### `mobile/app/track-order.tsx`
...
Input field works, tracking navigates to order detail, error shown for invalid order.
