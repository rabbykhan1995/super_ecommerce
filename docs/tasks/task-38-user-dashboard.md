# Task 38 — User Dashboard

> **Phase**: 11 — User Dashboard
> **Say**: "generate task 38" or "generate task 38"

## Objective

Create the user dashboard screen with user info and quick links.

## Reference

`/ecommerce/app/(dashboard)/user/page.tsx`
...
Dashboard displays user info, menu items navigate to correct screens.
