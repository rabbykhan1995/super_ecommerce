# Task 42 — My Orders List

> **Phase**: 11 — User Dashboard
> **Say**: "generate task 42" or "generate task 42"

## Objective

Create the order history list screen.

## Reference

`/ecommerce/app/(dashboard)/user/my-orders/page.tsx`

## File to Create

### `mobile/app/user/my-orders/index.tsx`
...
Orders list loads, displays order number, status badge, total, navigates to detail.
