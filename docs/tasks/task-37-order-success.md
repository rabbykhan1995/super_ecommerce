# Task 37 — Order Success Screen

> **Phase**: 10 — Cart & Checkout
> **Say**: "generate task 37" or "generate task 37"

## Objective

Create the order success confirmation screen.

## Reference

`/ecommerce/app/(with_footer)/order/success/page.tsx`
...
Success screen displays with check icon, buttons navigate correctly.
