# Task 21 — Forgot Password Screen

> **Phase**: 6 — Auth Screens
> **Say**: "generate task 21" or "generate task 21"

## Objective

Create the forgot password screen with email input.

## Reference

`/ecommerce/app/(with_footer)/forget-password/page.tsx`

## File to Create

### `mobile/app/forget-password.tsx`
...
Submit email → success message shown → link sent to email.
Submit invalid email → error toast.
