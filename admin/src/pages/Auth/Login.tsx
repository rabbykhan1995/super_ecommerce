...
export default function Login() {
  ...
  const handleGoogleLogin = () => {
    window.location.href = `${base_url}/auth/admin-google-auth`;
  };
      ...
      <div className="shadow-2xl rounded-2xl p-8 w-[90%] max-w-md dark:bg-gray-900">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-gray-500 dark:bg-gray-900">or</span>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors cursor-pointer"
        >
