...
export class AccountController {
  static async create(req: Request, res: Response) {
    const account: Account = await AccountService.create(req.body);
  ...
  static async update(req: Request, res: Response) {
    ...
    const account: Account = await AccountService.update(Number(req.params.id), req.body); // ✅ create না, update
  ...
  static async accountDetailsByID(req: Request, res: Response) {
    const account: Account = await AccountService.accountByID(Number(req.params.id));
