...
export const purchaseReturnTable = pgTable(
  "purchase_returns",
  {
    ...
    totalAmount: numeric("total_amount", {
      ...
      .default(0)
      .notNull(),
    paid: numeric("paid", { precision: 12, scale: 2, mode: "number" })
      .default(0)
      .notNull(),
  ...
  (table) => [
    ...
    index("purchase_returns_supplier_date_idx").on(
      table.supplierID,
      table.date,
    ),
  ],
...
export const purchaseReturnItemsTable = pgTable(
  "purchase_return_items",
  {
    ...
    purchaseReturnedQty: numeric("purchase_returned_qty", {
      precision: 10,
      scale: 2,
      mode: "number",
    })
...
export const purchaseReturnRelations = relations(
  purchaseReturnTable,
  ({ one, many }) => ({
